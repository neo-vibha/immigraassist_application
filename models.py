...
class Petition(db.Model):
    ...
    # I-140 Specific Petitioner Information
    trade_name = db.Column(db.String(255))
    uscis_account = db.Column(db.String(50))
    ...
    # I-140 Specific Beneficiary Information
    other_names_used = db.Column(db.String(5))
    city_of_birth = db.Column(db.String(100))
    visa_classification = db.Column(db.String(50))
